 ...
 <div class="container">
   ...
   <div class="content">
     ...
     <div v-if="uiProps.gameStarted">
       <h5>Hey! {{uiProps?.playerOne?.name}}, Enter your secret question</h5>
      <div class="question">
        <form action="">
          <div>
            <label for="question">Secret Question</label>
            <input type="text" v-model="uiProps.question.value">
          </div>
          <div>
            <label for="question">Question Hint</label>
...
export default {
  ...
  saveQuestion(){
    const question = GameModels.question
  }
  },
  computed: {
