  ...
  computed: {
    ...
    nextQuestion(){ 
      ...
      this.uiProps.questions.forEach( (item, i)=>{
        ...
        else if(self.uiProps.questions[item.questionKey].value.toLowerCase() === self.uiProps.answer.toLowerCase()) {
          self.uiProps.question.value = '';
          self.uiProps.question.hint = '';
          self.uiProps.answer = '';
          alert(`Correct Answer!!!`)
